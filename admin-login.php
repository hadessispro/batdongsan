    ...
    <section class="login">
      <div class="login-card">
        ...
        <form class="form" id="login-form">
          ...
          <div class="row">
            <div class="hint">Khuyên dùng tài khoản riêng và mật khẩu mạnh, không dùng mặc định. Nhập sai 5 lần liên tiếp sẽ bị khóa trong 72 giờ; đăng nhập đúng sẽ đặt lại bộ đếm.</div>
          </div>
